...
public class ParserTest {
    ...
    @Test
    public void parse_validTodo_returnsAddTodoCommand() throws InvalidInputException, InvalidCommandException {
        Command command = parser.parse("todo read book");
        assertInstanceOf(AddTodoCommand.class, command);
    }

    @Test
    public void parse_validTodo_returnsCorrectDescription() throws InvalidInputException, InvalidCommandException {
    ...
    @Test
    public void parse_validDeadline_returnsAddDeadlineCommand() throws InvalidInputException, InvalidCommandException {
        Command command = parser.parse("deadline submit report /by 28/08/2026 18:00");
        assertInstanceOf(AddDeadlineCommand.class, command);
    }

    @Test
    public void parse_validEvent_returnsAddEventCommand() throws InvalidInputException, InvalidCommandException {
    ...
    @Test
    public void parse_validList_returnsListCommand() throws InvalidInputException, InvalidCommandException {
        Command command = parser.parse("list");
        assertInstanceOf(ListCommand.class, command);
    }

    @Test
    public void parse_validMark_returnsCorrectTaskNumber() throws InvalidInputException, InvalidCommandException {
    ...
    @Test
    public void parse_validUnmark_returnsCorrectTaskNumber() throws InvalidInputException, InvalidCommandException {
    ...
    @Test
    public void parse_validDelete_returnsCorrectTaskNumber() throws InvalidInputException, InvalidCommandException {
    ...
    @Test
    public void parse_validBye_returnsExitCommand() throws InvalidInputException, InvalidCommandException {
